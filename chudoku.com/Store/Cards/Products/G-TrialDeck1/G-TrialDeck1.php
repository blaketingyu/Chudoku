...
$query=$con->prepare("select * from products where productName='G-Trial Deck 1 (Cardfight Vanguard)'");
$query->execute();
...
echo "<a href=\"/chudoku.com/store/cards/products/".$text."/".$text.".php\">";
echo "<h2>".$name."</h2></a>";
?>
</div>
<div id="container">
<div class="center">
	<?php
echo "<a href=\"/chudoku.com/store/cards/products/".$text."/".$text.".jpg\"><img src=\"/chudoku.com/store/cards/products/".$text."/".$text.".jpg\" width=\"400px\" height=\"600px\"></a>";
}
?>
</div>
</div>
