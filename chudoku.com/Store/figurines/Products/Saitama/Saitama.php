...
$query=$con->prepare("select * from products where productName='Saitama (One Punch Man)'");
$query->execute();
...
echo "<a href=\"/chudoku.com/store/".$category."/products/".$text."/".$text.".php\">";
echo "<h2>".$name."</h2></a>";
?>
</div>
<div id="container">
<div class="center">
<?php
echo "<a href=\"/chudoku.com/store/".$category."/products/".$text."/".$text.".jpg\"><img src=\"/chudoku.com/store/".$category."/products/".$text."/".$text.".jpg\" width=\"400px\" height=\"600px\"></a>";
}
?>
</div>
</div>	
