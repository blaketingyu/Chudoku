<!DOCTYPE html>
<html>
<link type="text/css" rel="stylesheet" href="stylesheetfigurines.css"/>
</head>
<?php
...
<!--header picture-->
<img src="figurines.jpg" height="300px" width="1300" style=float:center>
<!--The refine bar-->
<div class="refine">
	<h4 style="font-family:raleway">REFINE BY</h4>
	<hr width="200" align="left">
	<h4 style="font-family:raleway">Popular Original</h4>
	<a href="sort.php?value=OnePiece"><li style="font-family: Raleway" >One Piece</li></a>
	<a href="sort.php?value=OnePunchMan"><li style="font-family: Raleway" >One Punch Man</li></a>
</div>
...
$sort=$_POST['Sort'];
	if($sort == "asc")
	{
 $query=$con->prepare("select * from products where category = 'Figurines' ORDER BY unitsPrice ASC");
 $query->execute();
...
if($sort == "desc")
{
$query=$con->prepare("select * from products where category = 'Figurines' ORDER BY unitsPrice DESC");
 $query->execute();
$query->bind_result($productid,$name,$description, $price, $units, $picture, $supplier, $category);
while($query->fetch())
{
