...
<center><h1 style="font-family:raleway">Delete Product Page</h1></center>
<div class=admin>
		<?php
echo "</table>";
...
while($query->fetch())
{
	...
	echo "<td>".$supplier."</td>";
	echo "<td>".$category."</td>";
	$_SESSION['fromadmindelete']="yes";
	echo "<td><a href='deleteverify.php?operation=delete&productid=".$productid."'>Delete</a></td>";
	echo "</tr>";	
